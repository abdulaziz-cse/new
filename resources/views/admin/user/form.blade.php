...
<div class="form-group {{ $errors->has('roles') ? 'has-error' : ''}}">
    ...
    {!! Form::select('roles', Spatie\Permission\Models\Role::get()->pluck('name','name'), isset($user)?$user->roles:null,('' == 'required') ? ['class' => 'form-control', 'required' => 'multiple'] : ['class' => 'form-control' ,'multiple']) !!}
